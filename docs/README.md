...
<font color='red'>tips:</font> 知识不是重点，重点在于设计+运用
## pp❤️yy
...
- [RabbitMQ实现消息的消费确认，死信队列、延迟重试队列](https://blog.csdn.net/LittleBlackyoyoyo/article/details/94165862)
----
## Redis
### Redis笔记
...
- [需求分析淘宝聚划算功能](2020/redis/需求分析淘宝聚划算功能.md)
...
- [Spring Boot 和 Spring Cloud 应用内存如何管理](http://www.spring4all.com/article/20224)
----
